...
class _CreateFormState extends State<CreateForm> with CreateAccountMixin {
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              ValueListenableBuilder(
                ...
                builder: (_, value, child) {
                  return CustomTextField(
                    ...
                    hintText: getText(context, CreateAccountLangDif.tenUngdung),
                    maxLines: 1,
                    isObscure: false,
                    textError: value
                        ? getText(
                            context, CreateAccountLangDif.vuiLongNhapTenUngDung)
                        : null,
                    focusNode: focus,
                  );
                },
                ...
                child: Column(
                  children: [
                    CustomTextField(
                      ...
                      titleTextField:
                          getText(context, CreateAccountLangDif.tenDangNhap),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                if (widget
                                    .viewModel.txtPassword.text.isNotEmpty) {
                                  showDialog(
                                      context: context,
                                      builder: (context) {
                                        return AlertDialog(
              ...
              CustomTextField(
                requiredTextField: false,
                titleTextField: getText(context, CreateAccountLangDif.ghiChu),
              ...
              ValueListenableBuilder(
                  valueListenable: widget.viewModel.dynamicTextFieldNotifier,
                  builder: (context, value, child) {
                    return Column(
